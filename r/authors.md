...
- **Leo Thomson**. Author, maintainer.

- **The authors of the vendored Rust crates**. Copyright holder.  
  listed in inst/AUTHORS

## Citation

Source:
[`inst/CITATION`](https://github.com/l-thomson/thiessen/blob/dev/inst/CITATION)

Thomson L (2026). *thiessen: Bayesian Additive Voronoi Tessellations*. R
package version 0.0.0.9000, <https://github.com/l-thomson/thiessen>.

    @Manual{,
      title = {thiessen: Bayesian Additive Voronoi Tessellations},
      author = {Leo Thomson},
      year = {2026},
      note = {R package version 0.0.0.9000},
      url = {https://github.com/l-thomson/thiessen},
    }

Stone A, Gosling J (2025). “AddiVortes: (Bayesian) Additive Voronoi
